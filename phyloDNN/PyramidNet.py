...
class PyramidNet(nn.Module):
    '''num_classes = size of output representation (normalized to [0,1])'''
    ...
    def __init__(self, dataset, depth, alpha, num_classes, bottleneck=False):
        ...
        layers = {18: [2, 2, 2, 2], 34: [3, 4, 6, 3], 50: [3, 4, 6, 3], 101: [
            3, 4, 23, 3], 152: [3, 8, 36, 3], 200: [3, 24, 36, 3]}
        ...
        self.conv1 = nn.Conv1d(3, self.input_featuremap_dim,
    ...
    def pyramidal_make_layer(self, block, block_depth, stride=1):
        ...
        layers.append(block(self.input_featuremap_dim, int(
            round(self.featuremap_dim)), stride, downsample))
        ...
        self.input_featuremap_dim = int(
            round(self.featuremap_dim)) * block.outchannel_ratio
